        ...
        <div>
            ...
            <div className='md:max-w-screen-2xl w-11/12 mx-auto'>
                ...
                <div className=' md:w-4/5 w-11/12 mx-auto flex md:flex-row flex-col mb-10 gap-8'>
                    <div className=' md:w-[33.333] w-full flex flex-col justify-center items-center gap-5 shadow-custom py-10 px-6 text-center rounded-lg'>
                ...
                <div className=' md:w-1/2 w-11/12 mx-auto mb-20'>
                    <form>
                        ...
                        <div className=' mt-5'>
                            ...
                            <input class=" py-2 pl-2 focus:outline-0 focus:ring-0 focus:border-gray-300 border-2 border-gray-300 rounded-lg w-full mt-2" type="text" name="" id="" placeholder="Name" />
                        </div>
                        {/* email adress */}
                        <div className=' mt-5'>
                            <p className='font-bold text-black'>Email adress</p>
                            <input class="py-2 pl-2 focus:outline-0 focus:ring-0 focus:border-gray-300 border-2 border-gray-300 rounded-lg w-full mt-2" type="text" name="" id="" placeholder="email adress" />
                        </div>
                        {/* phone number */}
                        <div className=' mt-5'>
                            <p className=' font-bold text-black'>Phone</p>
                            <input class="py-2 pl-2 focus:outline-0 focus:ring-0 focus:border-gray-300 border-2 border-gray-300 rounded-lg w-full mt-2" type="text" name="" id="" placeholder="Phone" />
                        </div>
                        {/* message */}
                        <div className=' mt-5'>
                            <p className=' font-bold text-black'>Message</p>
                            <input class="py-2 pl-2 focus:outline-0 focus:ring-0 pb-32 focus:border-gray-300 border-2 border-gray-300 rounded-lg w-full mt-2" type="text" name="" id="" placeholder="message" />
                        </div>
